...
def handle_attack(message):
    ...
    if message.chat.id != int(GROUP_ID):
        bot.reply_to(message, "🚫 **👹𝘽𝙆𝙇,🍌 𝘽𝙎𝘿𝙆,🖕 𝙈𝘼𝙏𝙃𝙀𝙍𝘾𝙃𝙊𝘿🚀!! 𝘼𝙋𝙉𝙄 𝙂𝘼𝙉𝘿 𝙈𝙐𝙅𝙃𝙀 𝙈𝙏 𝘿𝙀! 𝙂𝙍𝙊𝙐𝙋 𝙈𝘼𝙄𝙉 𝙅𝘼 𝙆𝙀 𝘿𝙀- @R_SDanger !!** ❌")
        return

    if not is_user_in_channel(user_id):
        bot.reply_to(message, f"❗ **⚡🤬𝙈𝘼𝘾𝙃𝘾𝙃𝙊𝘿 𝘽𝙎𝘿𝙆 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙏𝙀𝙍𝘼 𝘽𝘼𝘼𝙋 𝙅𝙊𝙄𝙉 𝙆𝘼𝙍𝙂𝘼 𝙃𝘼𝙄! 𝙋𝙀𝙃𝙇𝙀 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙅𝙊𝙄𝙉 𝙆𝙍 𝙁𝙄𝙍 𝘼𝘼𝙉𝘼🍌! 𝙎𝘾𝙍𝙄𝙋𝙏𝙀𝘿 𝘽𝙔-- @R_SDanger !!** {CHANNEL_USERNAME} 🔥")
        return

    if pending_feedback.get(user_id, False):
        bot.reply_to(message, "😡 **☠️🔥𝘽𝙆𝙇 𝙈𝘼𝙏𝙃𝙀𝙍𝘾𝙃𝙊𝘿 𝙎𝘾𝙍𝙀𝙀𝙉𝙎𝙃𝙊𝙏 𝙏𝙀𝙍𝘼 𝘽𝘼𝘼𝙋 𝘿𝙀𝙂𝘼! 🤣𝙋𝙀𝙃𝙇𝙀 𝙎𝘾𝙍𝙀𝙀𝙉𝙎𝙃𝙊𝙏 𝘿𝙀 𝙁𝙄 𝙇𝙂𝘼𝙉𝘼🚀! 𝙎𝘾𝙍𝙄𝙋𝙏𝙀𝘿 𝘽𝙔-- @R_SDanger !!** 🔥")
        return

    if is_attack_running:
        bot.reply_to(message, "⚠️ **🍌𝘾𝙃𝙐𝘿𝘼𝙄 𝘼𝙇𝙍𝙀𝘼𝘿𝙔 𝘾𝙃𝘼𝙇𝙐 𝙃𝘼𝙄! 🤬𝙈𝘼𝙏𝙃𝙀𝙍𝘾𝙃𝙊𝘿 𝙋𝙀𝙃𝙇𝙀 𝙐𝙎𝙆𝙊 𝙋𝙐𝙍𝘼 𝙃𝙊𝙉𝙀 𝘿𝙊 𝙁𝙄𝙍 𝙇𝙂𝘼𝙉𝘼🚀! 𝙎𝘾𝙍𝙄𝙋𝙏𝙀𝘿 𝘽𝙔-- @R_SDanger !!**")
        return

    if len(command) != 4:
        bot.reply_to(message, "⚠️ **𝐔𝐒𝐀𝐆𝐄:** /RS  <IP>. <PORT>  <TIME> 𝙎𝘾𝙍𝙄𝙋𝙏𝙀𝘿 𝘽𝙔-- @R_SDanger !!")
        return
    ...
    bot.send_message(message.chat.id, f"🚀 **✅𝘾𝙃𝙐𝘿𝘼𝙄 𝙊𝙉 𝙃𝙊 𝙂𝘼𝙄 𝙃𝘼𝙄✅! 🖕🤬𝘽𝙆𝙇 𝘼𝙂𝙇𝙄 𝘾𝙃𝙐𝘿𝘼𝙄 𝙆𝙍𝙉𝙄 𝙃𝘼𝙄 𝙏𝙊𝙃 𝙎𝘾𝙍𝙀𝙀𝙉𝙎𝙃𝙊𝙏 𝘿𝙀?⚡! 𝙎𝘾𝙍𝙄𝙋𝙏𝙀𝘿 𝘽𝙔-- @R_SDanger !!**\n🎯 `{target} : {port}`\n⏳ {time_duration}s")
    ...
    bot.send_message(message.chat.id, "✅ **✅𝘾𝙃𝙐𝘿𝘼𝙄 𝙁𝙄𝙉𝙄𝙎𝙃𝙀𝘿✅!! 𝙈𝘼𝙏𝙃𝙀𝙍𝘾𝙃𝙊𝘿 𝘼𝙂𝘼𝙍 𝙋𝙀𝙃𝙇𝙀 𝙎𝘾𝙍𝙀𝙀𝙉𝙎𝙃𝙊𝙏 𝙉𝙃𝙄 𝘿𝙄𝙔𝘼 𝙏𝙊 𝘼𝘽 𝘿𝙀!!! 𝙎𝘾𝙍𝙄𝙋𝙏𝙀𝘿 𝘽𝙔-- @R_SDanger !!** 🚀")
...
def handle_screenshot(message):
    ...
    if pending_feedback.get(user_id, False):
        ...
        bot.reply_to(message, " **✅𝐒𝐂𝐑𝐄𝐄𝐍𝐒𝐇𝐎𝐓 𝐑𝐄𝐂𝐄𝐈𝐕𝐄𝐃✅! 🖕🖕𝘼𝘽 𝘿𝙐𝘽𝘼𝙍𝘼 𝘾𝙃𝙐𝘿𝘼𝙄 𝙆𝙍 𝙎𝘼𝙆𝙏𝙀 𝙃𝙊! 𝙎𝘾𝙍𝙄𝙋𝙏𝙀𝘿 𝘽𝙔-- @R_SDanger !!** 🚀")
